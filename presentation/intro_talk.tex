...
\item<+-> Clearly candidate 1 is better.
\end{itemize}
\end{frame}
...
\begin{itemize}
 ...
 \item<+-> One additional token $(<\_\_EN\_\_>, <\_\_FR\_\_>, <\_\_DE\_\_>, <\_\_ES\_\_>)$ indicating the target language.
...
\begin{frame}{Conclusion}
 \begin{itemize}
  ...
  \item<+-> \textquotedblleft Attention Is All You Need\textquotedblright arxiv preprint from Google threw away all LSTMS, Residual connections, etc., but managed to achieve BLEU score of 41.0 with only \textcolor{red} {feedforward connections and attention.}
 \end{itemize}
